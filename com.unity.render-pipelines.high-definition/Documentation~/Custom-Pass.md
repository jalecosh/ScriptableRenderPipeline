...
BeforePreRefraction | Color (no pyramid \| Read \| Write), Depth (Read \| Write), Normal (Read) | Buffers will contain all opaque objects. Use this pass to render any transparent objects that you want to be in the color pyramid (and in the refraction).
